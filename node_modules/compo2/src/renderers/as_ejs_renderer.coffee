AsEjs = require '../templating_engines/as_ejs/as_ejs'


# Renderer for AS_EJS files.
#
# This class renders a view stored in an .as_ejs file, using the given data structure
...
class AsEjsRenderer
  ...
  constructor: (@path) ->
    ...
    # The AsEjs instance that renders this file.
    @as_ejs = null
  ...
  render_directly: (response, data, done) ->
    ...
    @as_ejs.render data, writer_function, done



module.exports = AsEjsRenderer
